...
public class VideoBsonBig {
    ...
    public VideoBsonBig(SequenceGenerator seqGen, String name, long length, byte[] content, String email) {
    ...
    public VideoBsonBig(byte[] content) {
        this.content = content;
        this.documento = new Document()
    ...
    public String toString() {
        return "VideoBsonBig{" + "id=" + id + ", documento=" + documento + ", idVideo=" + idVideo + ", name=" + name + ", dateTime=" + dateTime + ", length=" + length + ", content=" + content + ", email=" + email + '}';
    }
